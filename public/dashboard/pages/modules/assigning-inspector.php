    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
            ...
            <div class="card p-3" style="box-shadow: 0px 0px 3px #777;">
                <h4 class="card-title">Assigning Inspector for :</h4>
                <div class="card-body">
                <div class="row">
                    <div class="col-md-4">
                        <p><b>Application ID :</b> 3115</p>
                    </div>
                    <div class="col-md-4">
                        <p><b>Name :</b> Robiul Hasan</p>
                    </div>
                    <div class="col-md-4">
                        <p><b>Submission Date :</b> 2011/04/25</p>
                    </div>
                </div>
                <div class="row">
                        <div class="col-md-4">
                            <p><b>View Application : </b><a href="#">View</a></p>
                        </div>
                        <div class="col-md-4">
                            <p><b>Type :</b> Leather</p>
                        </div>
                </div>
                </div>
            </div>
          
          <div class="card mt-3" style="box-shadow: 0px 0px 3px #777;">
            <div class="card-body">
                <h4 class="card-title">Assign Inspector</h4>
                <div class="row py-3" style="background-color: #eee; box-shadow: 0px 0px 3px #aaa;">
                  <div class="col-md-2">
                        <div class="form-group">
                                <label>Id</label>
                                <input type="text" class="form-control" placeholder="inspector id" />
                              </div>
              ...
              <h4 class="card-title pt-3">Inspector List</h4>
                  <div class="row">
                      <div class="col-md-2">
                          <div class="form-group">
                            <label>Inspector Id</label>
                            <input type="text" placeholder="inspector id" class="form-control">
                          </div>
                        </div>
                        <div class="col-md-2">
                                <div class="form-group">
                                  <label>Application Id</label>
                                  <input type="text" placeholder="application id" class="form-control">
                                </div>
                              </div>
                        <div class="col-md-2">
                            <div class="form-group">
                    ...
                    <table id="examplee" class="table table-striped table-bordered table-responsive" style="width:100%">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 240px;">Assigned For</th>
                                <th style="width: 240px;">Assigned Area</th>
                                <th style="width: 240px;">Assigned Date</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                ...
                                <td>Chittagong</td>
                                <td>All</td>
                                <td><botton class="btn btn-sm btn-danger">Assigned</botton></td>
                                <td>3111<br>3116</td>
                                <td>Chittagong</td>
                                <td>2011/04/25 - 2011/05/02</td>
                            ...
                            <tr>
                                ...
                                <td>Dhaka</td>
                                <td>Plastic</td>
                                <td><botton class="btn btn-sm btn-success">Not Assigned</botton></td>
                                <td>---</td>
                                <td>---</td>
                                <td>---</td>
                            </tr>
