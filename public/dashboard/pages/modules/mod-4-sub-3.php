          ...
          <div class="row">
            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card" style="box-shadow:0px 0px 3px #777">
                  <h4 class="pt-4 text-center">Inspection Report Management</h4>
                  ...
                  <table id="examplee" class="table table-striped table-bordered table-responsive" style="width:100%">
                      ...
                      <tbody>
                          ...
                          <tr>
                              ...
                              <td>
                                <div class="btn-group">
                                  <button class="btn btn-sm btn-success disabled" type="">Approve</button>
                                  <button class="btn btn-sm btn-danger disabled">Deny</button>
                                </div>
                              </td>
                          </tr>
                      </tbody>
