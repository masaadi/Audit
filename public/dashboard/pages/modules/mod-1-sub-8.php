                ...
                <div class="row p-3">
                    <div class="col-md-6">
                        <div class="card bg-warning">
                            <div class="card-body">
                              <h5 class="pt-2">Email</h5><hr>
                                <form class="forms-sample">
                                <div class="form-group">
                                    <label for="exampleInputUsername1">Old Email</label>
                                    <input type="text" class="form-control" id="exampleInputUsername1" placeholder="yourmail@email.com">
                                </div>
                                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <div class="card bg-danger">
                            <div class="card-body">
                              <h5 class="pt-2">Secret Code</h5><hr>
                                <div class="form-group">
                                    <label for="exampleInputUsername1">Enter your secrete Code for Verify</label>
                ...
                <div class="row p-3">
                    <div class="col-md-6">
                        <div class="card bg-success">
                            <div class="card-body">
                              <h5 class="pt-2">Number</h5><hr>
                                <form class="forms-sample">
                                <div class="form-group">
                                    <label for="exampleInputUsername1">Old Number</label>
                                    <input type="text" class="form-control" id="exampleInputUsername1" placeholder="+8801********">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputUsername1">New Number</label>
                                    <input type="text" class="form-control" id="exampleInputUsername1" placeholder="+8801********">
                                </div>
                                <button type="submit" class="btn btn-sm btn-primary">Submit</button>
                                </form>
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="exampleInputUsername1">Enter your secrete Code for Verify</label>
                                    <input type="text" class="form-control" id="exampleInputUsername1" placeholder="code">
                                </div>
                                <button type="submit" class="btn btn-sm btn-primary">Submit</button>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="forms-sample">
                                    <div class="form-group">
                                        <label for="exampleInputUsername1">Enter Old Password</label>
                                    ...
                                    <div class="form-group">
                                            <label for="exampleInputUsername1">Repeat New Password</label>
                                            <input type="text" class="form-control" id="exampleInputUsername1" placeholder="******">
                                        </div>
                                        <button type="submit" class="btn btn-sm btn-primary">Submit</button>
                                    </form>
