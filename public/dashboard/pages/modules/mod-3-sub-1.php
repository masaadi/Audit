          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card pt-2" style="box-shadow: 0px 0px 3px #777;">
                    ...
                    <div class="row p-3">
                      <div class="card bg-success" style="width: 100%; color: #fff;">
                        <div class="card-body text-center">
                            <h2 style="text-shadow: 1px 1px 3px rgb(122, 119, 119); margin-bottom: 0px;">Total Registered User : 05</h2>
                        </div>
                      </div>
                ...
                <div class="card">
                  <div class="card-body">
                      <h4 class="pb-1">Search for User</h4>
                    <div class="row">
                        <div class="col-md-3">
                          ...
                          <div class="col-md-3">
                              <div class="form-group">
                                <label>Email</label>
                                <input type="email" placeholder="yourmail@mail.com" class="form-control">
                              </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                  <label>Phone No</label>
                                  <input type="text" placeholder="+88019******" class="form-control">
                                </div>
                              </div>
                          <div class="col-md-3">
                              <div class="form-group">
                ...
                <table id="examplee" class="table table-striped table-bordered table-responsive" style="width:100%">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>+8801992969618</td>
                            <td>Juwel@gmail.com</td>
                            <td>Juwel</td>
                            <td>
                              
                                <button type="button" class="btn btn-primary btn-rounded btn-icon" data-toggle="modal" data-target="#exampleModal" title="Edit Info">
