                      ...
                      <table id="examplee" class="table table-striped table-bordered table-responsive" style="width:100%">
                          ...
                          <tbody>
                              <tr>
                                  ...
                                  <td>About getting started with small business</td>
                                  <td>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Sed, debitis quibusdam! Necessitatibus amet fugit pariatur, doloremque veritatis quas adipisci asperiores odit. Consequuntur aliquid amet omnis id possimus earum enim unde.</td>
                                  <td>
                              ...
                              <tr>
                                  ...
                                  <td>3113</td>
                                  <td>Faruk Molla</td>
                                  <td>How Long the Registration Processing takes</td>
                                  <td>Lorem ipsum dolor sit amet consectetur adipisicing elit. Vitae ratione quia consequatur, error iste quae corrupti doloribus, fugit quos libero sed animi facere repudiandae, amet perspiciatis distinctio vel impedit aperiam!</td>
                                  <td>
                                      <button type="button" class="btn btn-sm btn-success" data-toggle="modal" data-target="#exampleModal">
                                          View
                                        </button>
                              ...
                              <div class="col-md-6">
                                  <form action="">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="exampleInputUsername1" placeholder="search blog">
                                    </div>
                                  </form>
                              </div>
                              <div class="col-md-6 text-right">
                                  <button class="btn btn-primary">Creat Category</button>
                              </div>
                          </div>
                          <div class="row">
                              <div class="col-md-12">
                                  <div class="card">
                                      <div class="card-body">
                                            <div class="row">
                                                    ...
                                                    <div class="col-md-7">
                                                        <h4>How to Use E-registration</h4>
                                                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Debitis expedita incidunt quia, itaque quam, est at reprehenderit, ducimus voluptatem alias sit cum. Consequuntur accusamus, beatae distinctio natus perspiciatis ducimus dignissimos!
                                                          <a href="#">read more</a>
                                                        </p>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <ul style="list-style: none;">
                                                            <li><i class="mdi mdi-eye"></i> 5k view</li>
                                                            <li><a href="#"><i class="mdi mdi-message-reply"></i> Reply</a></li>
                                                            <li><i class="mdi mdi-timetable"></i> 27-11-2019</li>
                                                            <li><i class="mdi mdi-account-circle"></i> by Admin</li>
                                                        </ul>
                                                    </div>
                                                </div>
                                      </div>
