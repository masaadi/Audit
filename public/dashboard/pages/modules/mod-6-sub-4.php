          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card" style="box-shadow: 0px 0px 3px #777;">
                <div class="card-body">
                    <h4 class="card-title">Profile Update Sync Management</h4>
                <div class="row">
                    <div class="col-md-12">
                      <div class="card pt-2">
                        <div class="card-body">
                                  ...
                                  <div class="row">
                                      <div class="col-md-2">
                                        ...
                                        <div class="col-md-2">
                                          ...
                                          <div class="col-md-2">
                                              <div class="form-group">
                                                  <label>Ekshop ID</label>
                                                  <input type="Your Ekshop ID" placeholder="your id" class="form-control">
                                                </div>
                                            </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                        ...
                        <table id="examplee" class="table table-striped table-bordered table-responsive" style="width:100%">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width: 340px;">Ekshop ID</th>
