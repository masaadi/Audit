        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                <div class="card-body">
                  <h4 class="pt-2">Forgot Password</h4>
                <div class="row p-3">
                    <div class="col-md-6">
                        <div class="card bg-warning">
                            <div class="card-body">
                              <h5 class="pt-2">Email Verification</h5><hr>
                              <h6>Email</h6>
                                <div class="form-group">
                                    <input type="email" value="" class="form-control m-1">
                                    <span class="pt-2 pb-2" style="display: block;">Recover Your Password</span><br>
                    ...
                    <div class="col-md-6">
                      <div class="card bg-danger">
                        <div class="card-body">
                          <h5 class="pt-2">Number Verification</h5><hr>
                          <h6>Phone No</h6>
                            <div class="form-group">
                                <input type="email" value="" class="form-control m-1">
                                <span class="pt-2 pb-2" style="display: block;">Recover Your Password</span><br>
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="card bg-success">
                            <div class="card-body">
                              <h5 class="pt-2">Secret Question</h5><hr>
                              <h6>Select Question</h6>
                                <div class="form-group">
                                  <select class="form-control">
                                    ...
                                    <option>What is the nick name of your younger brother</option>
                                  </select><hr>
                                  <input type="text" value="" class="form-control m-1" placeholder="answer the question">
                                  <span class="pt-2 pb-2" style="display: block;">Recover Your Password</span><br>
                                  <button type="submit" class="btn btn-sm btn-primary">Submit</button>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                          <div class="card bg-info">
                            <div class="card-body">
                              <h5 class="pt-2">Creat Password</h5><hr>
                              <h6>New Password Recovery</h6>
                                <div class="form-group">
                                    <input type="password" value="" class="form-control m-1" placeholder="new password"><hr>
                                    <input type="password" value="" class="form-control m-1" placeholder="confirm password">
                                    <span class="pt-2 pb-2" style="display: block;">Recover Your Password</span><br>
                                    <button type="submit" class="btn btn-sm btn-primary">Submit</button>
                                </div>
                            </div>
