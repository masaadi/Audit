                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            <li class="nav-item text-center" style="width: 30%; border-radius: 10px 10px 0px 0px;">
                              <a class="nav-link active" id="overview-tab" data-toggle="tab" href="#overview" role="tab" aria-controls="overview" aria-selected="true" style="font-weight: 600; background-color: #eee; border: 1px solid #aaa; border-radius: 10px 10px 0px 0px;">
                                ...
                                <div class="row">
                                  <div class="col-md-1"><i class="mdi mdi-star-half" style="font-size: 20px;"></i></div>
                                  <div class="col-md-11 pt-1" style="font-size: 16px;">
                                      Feedback
                                  </div>
                                </div>
                              </a>
                            ...
                            <li class="nav-item text-center" style="width: 30%; border-radius: 10px 10px 0px 0px;">
                              <a class="nav-link" id="sales-tab" data-toggle="tab" href="#sales" role="tab" aria-controls="sales" aria-selected="false" style="font-weight: 600; background-color: #eee; border: 1px solid #aaa; border-radius: 10px 10px 0px 0px;">
                                  <div class="row">
                                      <div class="col-md-1"><i class="mdi mdi-check-circle" style="font-size: 20px;"></i></div>
                                      <div class="col-md-11 pt-1" style="font-size: 16px;">
                                        Suggestions
                                      </div>
                                    </div>
                              ...
                              <table id="examplee" class="table table-striped table-bordered table-responsive" style="width:100%">
                                  <thead>
                                      <tr>
                                          ...
                                          <th style="width: 300px;">Rivews</th>
                                  ...
                                  <tbody>
                                      <tr>
                                          ...
                                          <td>This Software is so Good and easy to use</td>
                                      ...
                                      <tr>
                                          ...
                                          <td>3113</td>
                                          <td>Faruk Molla</td>
                                          <td>Its almost solves my all problems</td>
                                          <td><i class="mdi mdi-star"></i><i class="mdi mdi-star"></i><i class="mdi mdi-star"></i><i class="mdi mdi-star"></i><i class="mdi mdi-star"></i></td>
                                          <td>
                                              <button type="button" class="btn btn-sm btn-warning" data-toggle="modal" data-target="#exampleModal">
                                                  View
                                      ...
                                      <tbody>
                                          <tr>
                                              <td>1</td>
                                                <td>3111</td>
                                                <td>Md juwel Khondokar</td>
                                                <td>This site should be more user friendly</td>
                                                <td>
                                                  <!-- Button trigger modal -->
