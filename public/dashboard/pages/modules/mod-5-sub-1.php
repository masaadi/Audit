                    ...
                    <div class="card-body dashboard-tabs p-0">
                      <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item text-center" style="width: 50%;">
                          <a class="nav-link active" id="overview-tab" data-toggle="tab" href="#overview" role="tab" aria-controls="overview" aria-selected="true" style="font-weight: 600; background-color: #eee; border: 1px solid #aaa;">
                            
                            <div class="row">
                              <div class="col-md-3"><i class="mdi mdi-cash" style="font-size: 80px;"></i></div>
                              <div class="col-md-9 pt-4" style="font-size: 18px;">
                                Total Applications Fee Collected<br>
                                500 Tk
                              </div>
                            </div>
                          </a>
                        ...
                        <li class="nav-item text-center" style="width: 50%;">
                          <a class="nav-link" id="sales-tab" data-toggle="tab" href="#sales" role="tab" aria-controls="sales" aria-selected="false" style="font-weight: 600; background-color: #eee; border: 1px solid #aaa;">
                              <div class="row">
                                  <div class="col-md-3"><i class="mdi mdi-cash" style="font-size: 80px;"></i></div>
                                  <div class="col-md-9 pt-4" style="font-size: 18px;">
                                    Total Registration Fee Collected<br>
                                    5000 Tk
                                  </div>
                                </div>
                          </a>
                                    ...
                                    <table id="examplee" class="table table-striped table-bordered table-responsive" style="width:100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="width: 140px;">Ammount</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
