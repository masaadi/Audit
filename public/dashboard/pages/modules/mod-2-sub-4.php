                                      ...
                                      <div class="col-md-2">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                              ...
                                              <input type="text" placeholder="token number here" class="form-control">
                                            </div>
                                          </div>
                                    <div class="col-md-1">
                                        <div class="form-group">
                              ...
                              <table id="examplee" class="table table-striped table-bordered table-responsive" style="width:100%">
                                  <thead>
                                      <tr>
                                          ...
                                          <th style="width: 300px;">Complain</th>
                                          <th>Token No</th>
                                          <th>Action</th>
                                      </tr>
                                  </thead>
                                  <tbody>
                                      <tr>
                                          ...
                                          <td>I am facing probem with my Registration</td>
                                          <td>401</td>
                                          <td>
                                      ...
                                      <tr>
                                          ...
                                          <td>3113</td>
                                          <td>Faruk Molla</td>
                                          <td>The Inspection report came out wrong, the Inspector should re-inspect my project</td>
                                          <td>413</td>
                                          <td>
                                              <button type="button" class="btn btn-sm btn-success" data-toggle="modal" data-target="#exampleModal">
                                                  View
                                          ...
                                          <div class="row">
                                                  <div class="col-md-2">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                          <label>Token No</label>
                                                          <input type="text" placeholder="token no" class="form-control">
                                                        </div>
                                                      </div>
                                                <div class="col-md-1">
                                                    <div class="form-group">
                                  ...
                                  <table id="examplee" class="table table-striped table-bordered table-responsive" style="width:100%">
                                      <thead>
                                          <tr>
                                              <th>SL</th>
                                              <th style="width: 300px;">Name</th>
                                              <th style="width: 300px;">Report</th>
                                              <th style="width: 300px;">Complain</th>
                                              <th>Token No</th>
                                              <th>Action</th>
                                          </tr>
                                      ...
                                      <tbody>
                                          <tr>
                                              <td>1</td>
                                                <td>Md juwel Khondokar</td>
                                                <td><button class="btn btn-sm btn-primary">View Report</button></td>
                                                <td>---</td>
                                                <td>402</td>
                                                <td>
                                                  <!-- Button trigger modal -->
