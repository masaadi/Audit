                ...
                <div class="card-body p-5">
                  ...
                  <form class="form-sample">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                              <input type="text" class="form-control" placeholder="father name here"/>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-4">
                          <div class="form-group row">
                            <label class="col-sm-4 col-form-label">NID Card</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" placeholder="NID no here"/>
                            </div>
                          </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                          <div class="form-group row">
                            <label class="col-sm-4 col-form-label">Parmanent Address</label>
                            <div class="col-sm-8">
                        ...
                        <div class="col-md-4">
                            <div class="form-group row">
                              ...
                              <div class="col-sm-8">
                                  <input type="text" class="form-control" placeholder="designation here" />
                              </div>
                            </div>
                          </div>
                      </div>
                      <div class="row">
                          ...
                          <div class="col-md-4">
                            <div class="form-group row">
                              ...
                              <div class="col-sm-8">
                                  <input type="text" class="form-control" placeholder="cpf no" />
                              </div>
                            </div>
                          </div>
                          <div class="col-md-4">
                              <div class="form-group row">
                                <label class="col-sm-4 col-form-label">BSCIC ID</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" placeholder="designation here" />
                                </div>
                              </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                          <div class="form-group row">
                            <label class="col-sm-4 col-form-label">Role Assign</label>
                            <div class="col-sm-8">
                                <select class="form-control">
