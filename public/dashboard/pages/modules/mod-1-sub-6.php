    ...
    <div class="container-fluid page-body-wrapper">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="generalCon">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item"> <a class="nav-link" href="../../pages/modules/mod-1-sub-5.php"> User Authentication </a></li>
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="card">
            <div class="card-body">
                 <h4 class="py-3">Verified User</h4>
              <div class="row">
                <div class="col-md-2">
    ...
    <table id="examplee" class="table table-striped table-bordered table-responsive" style="width:100%">
        <thead>
            <tr>
                ...
                <th style="width: 340px;">Designation</th>
                <th style="width: 340px;">Office</th>
                <th style="width: 340px;">Access</th>
