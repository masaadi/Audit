                                    ...
                                    <form action="" method="" style="width: 100%;">
                                      <div class="col-sm-12">
                                        ...
                                        <div class="row">
                                          ...
                                          <hr>
                                          <h5>Annual Raw Material Details and Requirements :</h5>
                                        <div class="row">
                                            <div class="col-sm-6 form-group">
                                              <label>Raw Materials :</label>
                                              <input type="text" placeholder="Raw Materials" class="form-control">
                                            </div>
                                            <div class="col-sm-6 form-group">
                                              <label>Quantity :</label>
                                              <input type="text" placeholder="Quantity" class="form-control">
                                          ...
                                          <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6 form-group">
                                                  ...
                                                  <input type="text" placeholder="Enter Land Type Here.." class="form-control">
                                                </div>	
                                                <div class="col-sm-6 form-group">
                                                  <label>Ammount :</label>
                                                  <input type="text" placeholder="Enter Ammount Here.." class="form-control">
                                                </div>			
                                              </div>
                                              <div class="row">
                                                  <div class="col-sm-6 form-group">
                                                    <label>Building Type :</label>
                                                    <input type="text" placeholder="Enter Building Type Here.." class="form-control">
                                                  </div>	
                                                  <div class="col-sm-6 form-group">
                                                    <label>Ammount :</label>
                                                    <input type="text" placeholder="Enter Ammount Here.." class="form-control">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6 form-group">
                                                      ...
                                                      <input type="text" placeholder="Enter Machinary Here.." class="form-control">
                                                    </div>	
                                                    <div class="col-sm-6 form-group">
                                                      <label>Ammount :</label>
                                                      <input type="text" placeholder="Enter Ammount Here.." class="form-control">
                                                  ...
                                                  <div class="row">
                                                      <div class="col-sm-6 form-group">
                                                        ...
                                                        <input type="text" placeholder="Enter Other Assets Here.." class="form-control">
                                                      </div>	
                                                      <div class="col-sm-6 form-group">
                                                        <label>Ammount :</label>
                                                        <input type="text" placeholder="Enter Ammount Here.." class="form-control">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12 form-group">
                                                      ...
                                                      <input type="text" placeholder="Enter Total Ammount Here.." class="form-control">
                                                    </div>
                                                  </div>
                                                  <h6 class="pt-3">B. Current Capital (1/3 Month)</h6>
                                                  <div class="row">
                                                      <div class="col-sm-6 form-group">
                                                        <label>Other Assets :</label>
                                                        <input type="text" placeholder="Enter Other Assets Here.." class="form-control">
                                                      ...
                                                      <div class="row">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-12 form-group">
                                                              ...
                                                              <input type="text" placeholder="Enter Total Investment Here.." class="form-control">
                                                            </div>
                                                          </div>
                                                          <hr>
                                                          ...
                                                          <div class="row">
                                                            ...
                                                            <div class="row">
                                                              ...
                                                              <hr>
                                          <h5>Machinary List :</h5>
                                          <h6 class="pt-3">a) Local Collected/ Collection</h6>
                                        <div class="row">
                                            <div class="col-sm-6 form-group">
                                              <label>1. Machine Name :</label>
                                              <input type="text" placeholder="Enter Machine Name Here.." class="form-control">
                                            </div>
                                            <div class="col-sm-6 form-group">
                                              <label>Quantity :</label>
                                          ...
                                          <div class="row">
                                            <div class="col-sm-8 form-group">
                                                ...
                                                <input type="text" placeholder="Enter Estimated Value Here.." class="form-control">
                                            </div>
                                            <div class="col-sm-4 form-group">
                                                <label></label>
                                                <button class="btn btn-sm btn-primary mt-4">Add More</button>
                                          ...
                                          <h6 class="pt-3">b) Imported/ Importable :</h6>
                                          <div class="row">
                                              <div class="col-sm-6 form-group">
                                                <label>1. Machine Name :</label>
                                                <input type="text" placeholder="Enter Machine Name Here.." class="form-control">
                                          ...
                                          <hr>
                                          <h5>Total Manpower (In Number) :</h5>
                                          <h6 class="pt-3">a) Management :</h6>
                                                          <div class="row">
                                                              <div class="col-sm-6 form-group">
                                                                <label>Local :</label>
                                                                <div class="row">
                                                                  <div class="col-6">
                                                                      <input type="text" placeholder="Male" class="form-control">
                                                                  </div>
                                                                  <div class="col-6">
                                                                      <input type="text" placeholder="Female" class="form-control">
                                                                  </div>
                                                                </div>
                                                              </div>
                                                              <div class="col-sm-6 form-group">
                                                            ...
                                                            <h6 class="pt-3">b) Skilled/Semi Skilled Employee/ Worker :</h6>
                                                          <div class="row">
                                                              <div class="col-sm-6 form-group">
                                                                <label>Local :</label>
                                                                <div class="row">
                                                            ...
                                                            <h6 class="pt-3">c) Non Skilled :</h6>
                                                          <div class="row">
                                                              <div class="col-sm-6 form-group">
                                                                <label>Local :</label>
                                                                <div class="row">
