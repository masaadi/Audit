          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form class="pt-3">
                ...
                <div class="mt-3">
                  <a class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" href="../inspector/inspection-report-submission.php">SIGN IN</a>
                </div>
                <div class="my-2 d-flex justify-content-between align-items-center">
                  ...
                  <a href="../../pages/user/login.php" class="btn btn-sm btn-primary">Entreprenuer Log in</a>
                </div>
              </form>
              <div class="row">
                <div class="col-md-6">
