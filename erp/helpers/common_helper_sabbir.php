...
function getResultTypeID($id){
    ...
    if ($language == "bn") {
        if($id == 1){
            return 'প্রথম বিভাগ / ক্লাস';
        }else if($id == 2){
            return 'দ্বিতীয় বিভাগ / ক্লাস';
        }else if($id == 3){
            return 'তৃতীয় বিভাগ / ক্লাস';
        // }else if($id == 4){
        //     return 'শ্রেণী';
        }
    }else{
       if($id == 1){
        return 'First Division/Class';
    }else if($id == 2){
        return 'Second Division/Class';
    }else if($id == 3){
        return 'Third Division/Class';
    // }else if($id == 4){
    //     return 'Grade';
    } 
}
...
function getOptionOffice_1($office_type_id)
{
    $ci = &get_instance();
    $ci->load->model('Common_Tasks');
    return $ci->Common_Tasks->list_office_typewise_99($office_type_id);
}
