...
function getOptionOffice_1($office_type_id)
{
    $ci = &get_instance();
    $ci->load->model('Common_Tasks');
    return $ci->Common_Tasks->list_office_typewise($office_type_id);
...
//menu load user wise
function usermodule_by_division_head($office_id)
{
    $ci = &get_instance();
    $ci->load->model('Common_Tasks');
    return $ci->Common_Tasks->listUserModuleByDivisionHead($office_id);
}
...
function getAllOffice()
{
    $ci = &get_instance();
    $ci->load->model('Common_Tasks');
    return $ci->Common_Tasks->AllOffice();
}
...
function getOptionDistrictByDivisionId($division_id)
{
    $ci = &get_instance();
    $ci->load->model('Common_Tasks');
    return $ci->Common_Tasks->listDistrictByDivisionId($division_id);
}

function getOptionUpazilaByDistrictId($district_id)
{
    $ci = &get_instance();
    $ci->load->model('Common_Tasks');
    return $ci->Common_Tasks->listUpazilaByDistrictId($district_id);
}
