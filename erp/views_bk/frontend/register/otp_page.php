                    ...
                    ?>  
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10">
                                    ...
                                    <label class="col-sm-4 col-form-label">DOT Employee</label>
                        ...
                        <div style="display:none" id="otp_sec">
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        <label id="user_label">Dot Number <span class="text-danger">*</span></label>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        <button type="button" class="btn btn-success" onclick="get_otp()" style="margin-top:28px">Get OTP</button>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        <label>Write OTP Here <span class="text-danger">*</span></label>
                                        <input type="text" name="otp_no" id="otp_no" class="form-control form-control-sm" value="" onblur="verify_otp()">
    ...
    $(function () {
        $('body').on('click', '#submit', function () {
                ...
                $('#form_register').validate({
                    ...
                    messages: {
                        full_name: {
                            required: 'DOT Number is requied.',
                        },
                        otp_no: {
    ...
    <script type="text/javascript">
        function get_otp(){
            ...
            $.ajax({
                ...
                success: function(result){
                  ...
                  if (result == '0') {
                    $('#message1').show().text("Invalid DOT Number").css("color","red");
        ...
        function verify_otp(){
            ...
            $.ajax({
                ...
                success: function(result){
                  if(result == '1'){
                    $('#message').show().text("OTP is matched").css("color","green");
                    $('#submit').attr("disabled", false);
                  }else if((result == '0')){
                    $('#message').show().text("OTP is not matched").css("color","red");
...
<script type="text/javascript">
  $('#company').click(function(){
    $('#user_label').text('Company ID');
    $('#otp_sec').show();
  });
  $('#employee').click(function(){
    $('#user_label').text('Dot Number');
    $('#otp_sec').show();
  });
</script>