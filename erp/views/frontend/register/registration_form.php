                ...
                <div class="card-body">
                    ...
                    <input type="hidden" name="user_type" value="<?= $user_type;?>" >
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label>Teletalk Employee Number </label>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="designation_name" class="form-control form-control-sm" value="" readonly>
                                    <input type="hidden" id="designation" name="designation" value=""readonly>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                <label>Salary Scale <span class="text-danger">*</span></label>
                                <input type="text" class="form-control form-control-sm" name="salary_scale" id="salary_scale" value="" readonly>                                </div>
                            </div>
                        </div>
						...
						<div class="row" id="erp_sec" style="display:none">
                            <div class="col-6">
                                <div class="form-group">
                                    <label>Erp Reference No <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control form-control-sm" name="erp_ref" id="erp_ref" value="">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label>Erp Reference Date <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control form-control-sm" name="erp_ref_date" id="erp_ref_date" value="" readonly>
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript">
    $(document).ready(function(){
        var emp_id = $('#employee_id').val();
          $.ajax({
            type:"Post",
            url:"<?php echo base_url() ?>siteadmin/get_emp/"+emp_id,
            dataType: "JSON",
