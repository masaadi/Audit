...
class Service_registration extends BaseController
{
    public function __construct()
    {
        ...
        $this->load->model('service/service_registration_model', 'personal_model');
    }
    ...
    public function index(){
        ...
        $config['base_url'] = base_url() . 'service/service_registration/index';
   ...
   public function paginate_data()
    {
        ...
        $config['base_url'] = base_url() . 'service/service_registration/paginate_data';
        $config['total_rows'] = $totalRec;
        $config['per_page'] = $this->total_row;
        $config['link_func'] = 'searchFilter';
        $this->ajax_pagination->initialize($config);
        ...
        $this->load->view('service/service_registration/home', $data);

    }
	
	public function add()
    {       
        $this->load->view('service/service_registration/entry');
    }
    ...
    public function added(){
        ...
        if(!empty($duplicate_check)){
			...
			$message = "Your%20registration%20is%20successfull%20for%20service,%20tracking%20number%20is.%20".$reg_no;
            if(!empty($reg_no)){
                $this->load->helper('sms_sender_helper');
                eng_sms($mobile,$message);
            }
    ...
    public function edit($id){
        ...
        $this->load->view('service/service_registration/edit', $data);
    }
    ...
    public function show_status($service_id){
        ...
        //echo "<pre>"; print_r($data); die();   
        $this->load->view('service/service_registration/status', $data);
    }
    ...
    public function show_query($service_id){
        ...
        //echo "<pre>"; print_r($data); die();   
        $this->load->view('service/service_registration/query_page', $data);
    }
    ...
    public function generateListPdf(){
        ...
        $data['pdf'] = 1;
        $html = $this->load->view('service/service_registration/pdf', $data, true);
        $mpdf->SetHtmlHeader('');
        $mpdf->WriteHTML($html);
    ...
    public function show($id){
        $data['service_register'] = $this->db->select('service_register.*,service_type.id as type_id,service_type.service_type')
                ...
                ->get('service_register')->row();
        //echo "<pre>"; print_r($data); die();      
        $this->load->view('service/service_registration/show', $data);
    }
