                    ...
                    <div class="row">
                      <table class="table table-bordered" id="children_table">
                        ...
                        <tr>
                          <td>1</td>
                          <td>
                            <select class="form-control" name="designation[]" id="designation_1" required="required">
                          ...
                          <td>
                            <select class="form-control" name="employee[]" id="employee_1" required="required">
                              <option>--select--</option>
                            </select>
                          </td>
