            ...
            <div class="col-md-12 grid-margin stretch-card">
              ...
              <h2 class="add_button">
                ...
                <div class="card-body p-5">
                  ...
                  <?php echo form_open_multipart('', array('id' => 'district_add')); ?>
                    ...
                    <div class="row">                                           
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-4 col-form-label">District Code :</label>
                          <div class="col-sm-8">
                    ...
                    <div class="row">
                        <div class="col-md-4"><button type="submit" class="btn btn-primary" id="submit"><?php echo $this->lang->line('save'); ?></button></div>
                    </div>
