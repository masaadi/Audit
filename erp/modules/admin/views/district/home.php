<table id="examplee" class="table table-striped table-bordered table-responsive" style="width:100%">
  <thead>
      <tr>
          ...
          <th style="width: 40%"><?php echo $this->lang->line('division'); ?></th>
          <th style="width: 40%"><?php echo $this->lang->line('district'); ?> <?php echo $this->lang->line('name'); ?></th>
          <th style=""><?= $this->lang->line('code')?></th>
    ...
    foreach ($wings as $data):?>
      ...
      ?>
        <tr>
            ...
            <td><?php echo Converter::en_to_bn($data['code']) ?></td> 
            <td>
