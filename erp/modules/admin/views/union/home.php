<table id="examplee" class="table table-striped table-bordered table-responsive" style="width:100%">
    <thead>
        <tr>
            ...
            <th style="width: 20%"><?php echo $this->lang->line('division'); ?></th>
            <th style="width: 20%"><?php echo $this->lang->line('district'); ?></th>
            <th style="width: 20%"><?php echo $this->lang->line('upazila'); ?></th>
            <th style="width: 20%"><?php echo $this->lang->line('union'); ?> <?php echo $this->lang->line('name'); ?></th>
           
            <th style="width: 15%"><?php echo $this->lang->line('status'); ?></th>
    ...
    foreach ($wings as $data):?>
          ...
          ?>
              <tr>
                  ...
                  <td><?php echo $data['union_name_bn'] ?></td>
                  <td>
