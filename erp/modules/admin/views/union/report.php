...
<body>
                        ...
                        <tr>
                            ...
                            <td class='text-center' >
                                <?php
                                    ...
                                    ?>
                                        <h5 class="mb-0"><?= $report_head[0]->report_heading_name_bn ?></h5>
                                        <p class="p_lcass">
                                        <?= $report_head[0]->address_bn ?>
                                        </p>
                                ...
                                <?php endif ?>
                                <h5 class="mt-1"><?= $this->lang->line('union').' '.$this->lang->line('report') ?></h5>
			...
			<div class="row">
				<div class="col-sm-12 mt-4">
                    <table id="list_table" class="table table-striped table-bordered table-responsive" style="width:100%">
                        <thead>
                            <tr>
                                ...
                                <th style=""><?= $this->lang->line('union')?></th>
                            </tr>
                        </thead>
                        <tbody>
                        <?php if (!empty($wings)):
