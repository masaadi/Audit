              ...
              <div class="d-flex flex-wrap justify-content-xl-between">
                <div class="d-none d-xl-flex border-md-right flex-grow-1 align-items-center justify-content-center item">
                  ...
                  <div class="d-flex flex-column justify-content-around">
                    <small class="mb-1 text-muted"><?= $this->lang->line('total_applications')?></small>
                ...
                <div class="d-flex border-md-right flex-grow-1 align-items-center justify-content-center item">
                  ...
                  <div class="d-flex flex-column justify-content-around">
                    <small class="mb-1 text-muted"><?= $this->lang->line('pending_applications')?></small>
                  ...
                  <div class="col-md-12">
                    <div class="card pt-2">
                      <div class="card-body">
                        <div class="row">
                          <div class="col-md-6">
                            <h4 class="pb-1 text-left"><?= $this->lang->line('new_application')?></h4>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-md-2">
                        ...
                        <div id="postList">
                          <?php $this->load->view('application/new/all_list_data');?>
                        </div>
...
<script type="text/javascript">
  function searchFilter(page_num) {
    ...
    //if ($err_count == 1)  {
      $.ajax({
        type: 'POST',
        url: '<?php echo base_url(); ?>new_application/page_data/' + page_num,
