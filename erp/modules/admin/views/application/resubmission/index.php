              ...
              <div class="d-flex flex-wrap justify-content-xl-between">
                <div class="d-none d-xl-flex border-md-right flex-grow-1 align-items-center justify-content-center item">
                  ...
                  <div class="d-flex flex-column justify-content-around">
                    <small class="mb-1 text-muted"><?= $this->lang->line('total_resubmission')?></small>
                ...
                <div class="d-flex border-md-right flex-grow-1 align-items-center justify-content-center item">
                  ...
                  <div class="d-flex flex-column justify-content-around">
                    <small class="mb-1 text-muted"><?= $this->lang->line('pending_resubmission')?></small>
                ...
                <div class="d-flex border-md-right flex-grow-1 align-items-center justify-content-center item">
                  ...
                  <div class="d-flex flex-column justify-content-around">
                    ...
                    <h5 class="mr-2 mb-0"><?= $total_application*$fees[0]['app_form_fees']?></h5>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-12">
                    <div class="card pt-2">
                      <div class="card-body">
                        <div class="row">
                          <div class="col-md-6">
                            <h4 class="pb-1 text-left"><?= $this->lang->line('resubmission')?></h4>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-md-2">
                        ...
                        <div id="postList">
                          <?php $this->load->view('application/resubmission/all_list_data');?>
                        </div>
...
<script type="text/javascript">
  function searchFilter(page_num) {
    ...
    //if ($err_count == 1)  {
      $.ajax({
        type: 'POST',
        url: '<?php echo base_url(); ?>resubmission/page_data/' + page_num,
