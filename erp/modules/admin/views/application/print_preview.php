   ...
   <body>
                  ...
                  <tr>
                     <td>
                        <?php
                           ...
                           $image_head = 'data:image/jpg;base64,'.base64_encode(file_get_contents('/var/www/e-registration.bscic.gov.bd/public_html/public/uploads/'.$heading[0]['right_logo']));
                           $image_pro = 'data:image/jpg;base64,'.base64_encode(file_get_contents('/var/www/e-registration.bscic.gov.bd/public_html/public/uploads/'.$posts[0]['photo1']));
                        ?>
                        <div class="Clogo">
                         <img src="<?php echo $image_head ?>" width="100" alt="">
                        </div>
                     </td>
                     <td>
                        <div class="Cname" style="margin-top:-20px">
                           <h5><?= $head_name ?></h5>
                           <p class="p_lcass" ><?= $head_address ?></p>
                        </div>
                     </td>
                  </tr>
               </table>
            ...
            <table width='100%'>
               <tr>
                  <td style="border: 0px; width:2in; padding-right: 10px;">
                    <img src="<?php echo $image_pro ?>" width="1.37in" alt="">
                  </td>
                  <td style="border: 0px;">
                     <div class="">
                        <?php 
      ...
      <div class="container">
        ...
        <div class="fixed-assets">
            ...
            <div class="wrapper">
              <div id="left" style="float:left; width:50%; overflow:hidden; background-color: #F3F3F3; ">
                  <div style="text-align: center; border: 1px solid #ddd; border-bottom: none;"><b><?= $this->lang->line('local')?></b></div>
                  <table>
                    <tbody>
                        <tr>
                            <td style="text-align: center;">
                            ...
                            <td style="text-align: center;"><?=($management_employee)?$management_employee->local->female:''?></td>
                        </tr>
                    </tbody>
                </table>
              </div>
              <div id="right" style="float:left; width:50%; overflow:hidden; background-color: #F3F3F3;">
                  <div style="text-align: center; border: 1px solid #ddd; border-bottom: none; border-left: none;"><b><?= $this->lang->line('foreigner')?></b></div>
                  <table style="border: none !important;">
                    <tbody>
                        <tr>
                            ...
                            <td style="text-align: center;"><?=($management_employee)?$management_employee->foreigner->female:''?></td>
                        </tr>
                    </tbody>
                </table>
              </div>
                  ...
                  <table>
                    <tbody>
                        <tr>
                            ...
                            <td style="text-align: center;"><?=($skilled_sem_skl_emp)?$skilled_sem_skl_emp->local->female:''?></td>
                        </tr>
                    </tbody>
                </table>
              </div>
                  ...
                  <table style="border: none !important;">
                    <tbody>
                        <tr>
                            ...
                            <td style="text-align: center;"><?=($skilled_sem_skl_emp)?$skilled_sem_skl_emp->foreigner->female:''?></td>
                        </tr>
                    </tbody>
                </table>
              </div>
                  ...
                  <table>
                    <tbody>
                        <tr>
                            ...
                            <td style="text-align: center;"><?=($unskilled_employee)?$unskilled_employee->local->female:''?></td>
                        </tr>
                    </tbody>
                </table>
              </div>
                  ...
                  <table style="border: none !important;">
                    <tbody>
                        <tr>
                            ...
                            <td style="text-align: center;"><?=($unskilled_employee)?$unskilled_employee->foreigner->female:''?></td>
                        </tr>
                    </tbody>
                </table>
              </div>
            ...
            <table>
               <thead>
                  <tr>
                     ...
                     <th width='20%' style='text-align:center'><?= $this->lang->line('file')?></th>
                  </tr>
               </thead>
               <tbody>
                  <tr>
                     ...
                     <td  style='text-align:center' ><?php echo ($posts[0]['photo2']=='')?'<span class="no">✖</span>':'<span class="yes">✔</span>' ?></td>
                  </tr>
                  <tr>
                     ...
                     <td  style='text-align:center'><?php echo ($posts[0]['photo3']=='')?'<span class="no">✖</span>':'<span class="yes">✔</span>' ?></td>
                  </tr>
                  <tr>
                     <th><?= $this->lang->line('trade_license')?></th>
                     <td><?= ($language=='bn')? Converter::en_to_bn($posts[0]['license_no']) : $posts[0]['license_no'] ?></td>
                     <td  style='text-align:center'><?php echo ($posts[0]['photo4']=='')?'<span class="no">✖</span>':'<span class="yes">✔</span>' ?></td>
                  </tr>
                  <tr>
                     <th><?= $this->lang->line('m_a')?></th>
                     <td>&nbsp;</td>
                     <td  style='text-align:center'><?php echo ($posts[0]['photo5']=='')?'<span class="no">✖</span>':'<span class="yes">✔</span>' ?></td>
                  </tr>
                  <tr>
                     <th><?= $this->lang->line('incorporation_certificate')?></th>
                     <td>&nbsp;</td>
                     <td  style='text-align:center'><?php echo ($posts[0]['photo6']=='')?'<span class="no">✖</span>':'<span class="yes">✔</span>' ?></td>
                  </tr>
                  <tr>
                     <th><?= $this->lang->line('partnership_agreement')?></th>
                     <td>&nbsp;</td>
                     <td  style='text-align:center'><?php echo ($posts[0]['photo7']=='')?'<span class="no">✖</span>':'<span class="yes">✔</span>' ?></td>
                  </tr>
               </tbody>
            </table>
         </div>
            ...
            <table >
               ...
               <tbody>
                  <?php
                     ...
                     echo '<td  style="text-align:center!important">'. $file.'</td>';
                     echo '</tr>';
                     }
                     ?>
               </tbody>
            ...
            <table>
               <tbody>
                  ...
                  <tr>
                     ...
                     <td  style='text-align:center'><?php echo ($posts[0]['file_land']=='')?'<span class="no">✖</span>':'<span class="yes">✔</span>' ?></td>
                     <th><?= $this->lang->line('other_aditional_land_document')?></th>
                     <td><?= $posts[0]['land_additional_documents']?></td>
                     <td  style='text-align:center'><?php echo ($posts[0]['file_land_documents']=='')?'<span class="no">✖</span>':'<span class="yes">✔</span>' ?></td>
                  </tr>
                  <tr>
                     ...
                     <td  style='text-align:center'><?php echo ($posts[0]['file_building']=='')?'<span class="no">✖</span>':'<span class="yes">✔</span>' ?></td>
                     <th><?= $this->lang->line('other_aditional_building_document')?></th>
                     <td><?= $posts[0]['building_additional_documents']?></td>
                     <td  style='text-align:center' ><?php echo ($posts[0]['file_building_documents']=='')?'<span class="no">✖</span>':'<span class="yes">✔</span>' ?></td>
                  </tr>
               </tbody>
            </table>
            <p  style="margin-top:10px;text-align:center"><?= $this->lang->line('preview_footer') ?></p>
         </div>
         <?php 
            }
            ?>
