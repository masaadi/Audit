              ...
              <div class="d-flex flex-wrap justify-content-xl-between">
                <div class="card ">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-md-6">
                        <h4 class="pb-1 text-left"><?= $this->lang->line('approved_application')?></h4>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-2">
                    ...
                    <div id="postList">
                      <?php $this->load->view('application/approve/all_list_data');?>
                    </div>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body" style="text-align: center;">
              <h4><?= $this->lang->line('approach_for_inspection')?></h4>
              <span class="error" id="data_error"></span>
              <br>
              <input type="hidden" name="contact_id" id="contact_id">
              <button type="button" class="btn btn-lg btn-primary mt-2" onclick="approved_data()"><?= $this->lang->line('submit')?></button>
            </div>
          </div>
        </div>
      </div>
...
<script type="text/javascript">
  function searchFilter(page_num) {
    ...
    //if ($err_count == 1)  {
      $.ajax({
        type: 'POST',
        url: '<?php echo base_url(); ?>admin/approved_app_page_data/' + page_num,
...
function approved_data(){
  ...
  if(contact_id!=''){
    //alert(contact_id);
      $.ajax({
        type: 'POST',
        url: '<?php echo base_url(); ?>admin/application/inspection',
