                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="representative" id="representative" value="">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="">Phone<sup class="error">*</sup></label>
                                <input type="number" class="form-control" name="phone" minlength="11" maxlength="11" id="phone" value="">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
