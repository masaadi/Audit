            ...
            <div class="col-md-12 grid-margin stretch-card">
              ...
              <h2 class="add_button">
                ...
                <div class="card-body p-5">
                  ...
                  <?php echo form_open_multipart('', array('id' => 'menu_edit')); ?>
                   ...
                   <div class="row">
					   ...
					   <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                            <?php echo form_dropdown("module_id",$module_list,$array[0]->module_id,"id='module_id' class='form-control'"); ?>
                          </div>
                        </div>
                      </div>
                     <div class="col-md-6">
