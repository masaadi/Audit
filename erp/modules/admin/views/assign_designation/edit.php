        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                ...
                <div class="card-body p-5">
                    <?php echo form_open_multipart('', array('id' => 'designation_edit')); ?>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <?php echo form_dropdown("office_id",office(), $array[0]->office_id,"id='office_id' class='form-control'"); ?>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <?php echo form_dropdown("designation_id",getOptionDesignation(), $array[0]->designation_id,"id='designation_id' class='form-control'"); ?>
                                </div>
                            </div>
                        </div>
                    </div>
