...
$post_content = array(
    ...
    'class' => 'form-control',
     'placeholder'=> "",
    'required'=>"required",
    'value' =>  $array[0]->post_content,
);

 $post_content_bn = array(
    'name'  => 'post_content_bn',
    'id'    => 'post_content_bn',
    'class' => 'form-control',
     'placeholder'=> "",
    'required'=>"required",
    'value' =>  $array[0]->post_content_bn,
);
            ...
            <div class="col-md-12 grid-margin stretch-card">
              ...
              <h2 class="add_button">
                ...
                <div class="card-body p-5">
                  ...
                  <?php echo form_open_multipart('', array('id' => 'blog_edit')); ?>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-12">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                            <?php echo form_input($post_title_bn); ?>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-12">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                            <?php echo form_textarea($post_content_bn); ?>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-12">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                            <input type="file" name="post_img" id="post_img"><br><br>
                            <img width="150px;" src="<?php echo base_url('public/uploads/').$array[0]->post_img;?>">
                          </div>
                        </div>
                      </div>
                    </div>
