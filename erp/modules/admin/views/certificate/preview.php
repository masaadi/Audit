...
<div class='text-center mb-2'>
    <a href="<?= base_url() ?>certificate/preview-pdf/<?= $certificate[0]->id ?>" class="btn btn-success btn-sm"><?= $this->lang->line('download') ?></a>
</div>
          ...
          <div class="content">
              ...
              <div class="body">
                  <p style="margin-left: 10px;">প্রত্যয়ন করা যাচ্ছে যে, প্রস্তাবিত শিল্প কারখানাটি বিসিক কর্তৃক যথাযথভাবে নিবন্ধিত হয়েছে।<br>
                      নিবন্ধন তারিখ: &nbsp;<span><?= Converter::en_to_bn(date("Y-m-d",strtotime($certificate[0]->updated_date))) ?></span><br>
                      নিবন্ধন নং: &nbsp;<span><?= Converter::en_to_bn($certificate[0]->certificate_no) ?></span><br>
...
?>
    industrial plant has been duly registered by BSCIC.<br>
                      Registration Date : &nbsp;<span><?=date("Y-m-d",strtotime($certificate[0]->updated_date)) ?></span><br>
                      Registration No : &nbsp;<span><?= $certificate[0]->certificate_no_en ?></span><br>
        ...
        <div  class="content">
            ...
            color: #fff;">
                    <table style="width: 100%;color:white">
                        <tr>
                            <td>
                                <div style="margin-right: auto;">নিবন্ধন সংখা :  <?= isset($certificate[0]->certificate_no)?  Converter::en_to_bn($certificate[0]->certificate_no):''?>   </div>
                            </td>
                            <td style="text-align:center"> 
                            ...
                            <td style="text-align:right">
                                <div >তারিখ : <?= isset($certificate[0]->updated_date)? Converter::en_to_bn(date("Y-m-d",strtotime($certificate[0]->updated_date))):''?>  </div>
                            </td>
                        </tr>
                    </table>
                </div>
...
<script>
    <?php
        $qr_text= "Certificate NO : ".$certificate[0]->certificate_no_en." ,Application Date : ".$posts[0]['created_date']." ,Project Name : ".$posts[0]['org_name'];
    ?>
    $('#qrcode').empty();
