                ...
                <table width='100%'>
                   <tr>
                      <td style="text-align:center">
                          <img  src="<?= pdf_path().$heading[0]['right_logo']?>" alt="" width="80px">
                      </td>
                   </tr>
                </table>
                <br>
                ...
                <footer>
                   <table width='100%'>
                      <tr>
                         <td style="text-align: center;">
                            <?php 
                                 echo '<img width="200px" height="200px" src="'.pdf_path().'certificates/qr_code/'.$certificate[0]->certificate_serial.'.png" />';
                            ?>
                         </td>
                      </tr>
                   </table>
     ...
     <div class="border">
          <div class="content">
              ...
              <table width='100%'>
                 <tr>
                    <td style="text-align:center">
                       <h1 style="font-weight: bold;font-size: 20px" class="main-title">
<?php echo  $head_name ?></h1>
                    </td>
                 </tr>
                 <tr>
                    <td style="text-align:center">
