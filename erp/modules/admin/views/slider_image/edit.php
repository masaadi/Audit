            ...
            <div class="col-md-12 grid-margin stretch-card">
              ...
              <h2 class="add_button">
                ...
                <div class="card-body p-5">
                  ...
                  <?php echo form_open_multipart('', array('id' => 'slider_image_edit')); ?>
                      ...
                      <div class="col-md-12">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                            ...
                            <img width="150px;" src="<?php echo base_url('public/uploads/').$array[0]->image_url;?>">
                          </div>
                        </div>
                      </div>
                    </div>
