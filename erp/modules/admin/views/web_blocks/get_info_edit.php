 ...
 $get_info_title_bn = array(
    ...
    'class' => 'form-control',
     'placeholder'=> "",
    'required'=>"required",
    'value' =>  $get_info[0]->block_title_bn,
);
...
$get_info_content = array(
    ...
    'class' => 'form-control',
     'placeholder'=> "",
    'required'=>"required",
    'value' =>  $get_info[0]->block_content,
);
 ...
 $get_info_content_bn = array(
    ...
    'class' => 'form-control',
     'placeholder'=> "",
    'required'=>"required",
    'value' =>  $get_info[0]->block_content_bn,
);

?>

<?php echo form_open_multipart('', array('id' => 'get_info_edit')); ?>
    <p class="card-description">
      <input type="hidden" name="id" value="<?php echo $get_info[0]->id ?>" />
    </p>
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="col-md-12">
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              ...
              <input type="hidden" name="up_image_url1" value="<?php echo $get_info[0]->image_url1;?>">
              <br>
              <img width="100px" src="<?php echo base_url('public/uploads/').$get_info[0]->image_url1;?>">
            </div>
          </div>
        </div>
        <div class="col-md-12">
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              ...
              <input type="hidden" name="up_image_url2" value="<?php echo $get_info[0]->image_url2;?>">
              <br>
              <img width="100px" src="<?php echo base_url('public/uploads/').$get_info[0]->image_url2;?>">
            </div>
          </div>
        </div>
    </div>     
    ...
    $(function () {
      $('body').on('click', '#edit_submit', function () {
        ...
        $('#get_info_edit').validate({
          ...
          messages: {
              get_info_title: {
                  required: 'Get Information title is required',
              },
              get_info_title_bn: {
                  required: 'Get Information title (Bangla) is required',
              },
              get_info_content: {
                  required: 'Get Information content is required',
              },
              get_info_content_bn: {
                  required: 'Get Information content (Bangla) is required',
              },
          },
          submitHandler: function (form) {
            ...
            var form = $(this);
            //debugger;
            var currentForm = $('#get_info_edit')[0];
            var formData = new FormData(currentForm);                        
            $.ajax({
                url: "<?php echo base_url() ?>admin/web_blocks/update_get_info",
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
