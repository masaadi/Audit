...
class Qualification_info extends BaseController
{
    public function __construct()
    {
        ...
        $this->load->model('applicant/qualification_info_model', 'personal_model');
    }
    ...
    public function index(){
        ...
        $config['base_url'] = base_url() . 'applicant/qualification_info/index';
   ...
   public function paginate_data()
    {
        ...
        $config['target'] = '#blogList';
        $config['base_url'] = base_url() . 'applicant/qualification_info/paginate_data';
        $config['total_rows'] = $totalRec;
        $config['per_page'] = $this->total_row;
        $config['link_func'] = 'searchFilter';
        $this->ajax_pagination->initialize($config);
        ...
        $this->load->view('applicant/qualification_info/home', $data);

    }
	
	public function add()
    {       
        $this->load->view('applicant/qualification_info/entry');
    }
    ...
    public function edit($employee_id,$page){
        ...
        $this->load->view('applicant/qualification_info/edit', $data);
    }
    ...
    public function show($employee_id,$count1){
        $data['qualification_info'] = $this->db->select('qualification_info.*,personal_info.employee_name')->join('personal_info','qualification_info.employee_id = personal_info.employee_id')->where('qualification_info.employee_id',$employee_id)->get('qualification_info')->result();
        //echo "<pre>"; print_r($data['education_info']); die();      
        $this->load->view('applicant/qualification_info/show', $data);
    }
