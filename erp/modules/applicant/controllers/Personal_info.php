...
class Personal_info extends BaseController
{
    public function __construct()
    {
        ...
        $this->load->model('applicant/personal_info_model', 'personal_model');
    }
    ...
    public function index(){
        ...
        $config['base_url'] = base_url() . 'applicant/personal_info/index';
   ...
   public function paginate_data()
    {
        ...
        $config['target'] = '#blogList';
        $config['base_url'] = base_url() . 'applicant/personal_info/paginate_data';
        $config['total_rows'] = $totalRec;
        $config['per_page'] = $this->total_row;
        $config['link_func'] = 'searchFilter';
        $this->ajax_pagination->initialize($config);
        ...
        $this->load->view('applicant/personal_info/home', $data);

    }
	
	public function add()
    {       
        $this->load->view('applicant/personal_info/entry');
    }
    ...
    public function edit($id){
        ...
        $this->load->view('applicant/personal_info/edit', $data);
    }
    ...
    public function show($id,$count1){
        ...
        $this->load->view('applicant/personal_info/show', $data);
    }
