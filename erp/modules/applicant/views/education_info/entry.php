                ...
                <div class="card-body p-5">
                  ...
                  <div class="row">
                      ...
                      <table class="table table-bordered" id="children_table">
                        ...
                        <tr>
                          <td>
                            <input class="form-control" type="text" name="exam_name[]" value="" required>
                          </td>
                          <td>
                            <input class="form-control" type="text" name="subject[]" value="" required>
                          </td>
                          <td>
                            <input class="form-control" type="text" name="institute[]" value="" required>
                          </td>
                          <td>
                            <input class="form-control" type="text" name="pass_year[]" value="" required>
                          </td>
                          <td>
                            <input class="form-control" type="text" name="result[]" value="" required>
                          </td>
                          <td>
                            <input class="form-control" type="text" name="board[]" value="" required>
                          </td>
                          <td>
