                  ...
                  <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                            <input type="text" class="form-control" name="employee_name" id="employee_name" value="<?= $employee->employee_name;?>" readonly>
                          </div>
                        </div>
                      </div>
                  </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                            <input type="text" class="form-control" name="joining_date" id="joining_date" value="<?= $employee->joining_date;?>" readonly>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                           <?php echo form_dropdown('joining_office', office(), $employee->joining_office, 'id="joining_office" class="form-control"'); ?>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                            <?php echo form_dropdown('joining_desig', getOptionDesignation(), $employee->joining_desig, 'id="joining_desig" class="form-control"'); ?>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                            <input type="text" class="form-control" name="joining_grade" id="joining_grade" value="<?= $employee->joining_grade;?>">
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                            <input type="text" class="form-control" name="joining_scale" id="joining_scale" value="<?= $employee->joining_scale;?>">
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                            <input type="text" class="form-control" name="joining_basic" id="joining_basic" value="<?= $employee->joining_salary;?>">
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                            <input type="text" class="form-control" name="current_joining" id="current_joining" value="<?= $employee->current_joining;?>" readonly>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-4 col-form-label">Office Name</label>
                          <div class="col-sm-8">
                            <?php echo form_dropdown('current_office', office(),$employee->current_office, 'id="current_office" class="form-control"'); ?>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                            <?php echo form_dropdown('section', section(), $employee->section, 'id="section" class="form-control"'); ?>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-4 col-form-label">Designation<sup class="error">*</sup></label>
                          <div class="col-sm-8">
                            <?php echo form_dropdown('cuurent_desig', getOptionDesignation(), $employee->current_desig, 'id="cuurent_desig" class="form-control"'); ?>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                            <select class="form-control" name="posting_status" id="posting_status">
                              ...
                              <option value="Direct" <?php if($employee->posting_status == 'Direct'){echo "selected";}?> >Direct</option>
                              <option value="Promotional" <?php if($employee->posting_status == 'Promotional'){echo "selected";}?> >Promotional</option>
                            </select>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                            <input type="text" class="form-control" name="current_grade" id="current_grade" value="<?= $employee->current_grade;?>">
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                            <input type="text" class="form-control" name="current_scale" id="current_scale" value="<?= $employee->current_scale;?>">
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                            <input type="text" class="form-control" name="current_basic" id="current_basic" value="<?= $employee->current_basic;?>">
                          </div>
                        </div>
                      </div>                 
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                            <?php echo form_dropdown('emp_type', emp_type(), $employee->emp_type, 'id="emp_type" class="form-control"'); ?>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                            <input type="text" class="form-control" name="emp_class" id="emp_class" value="<?= $employee->emp_class;?>">
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                            <select class="form-control" name="quota" id="quota">
                              <option value="">---select---</option>
                              <option value="1" <?php if($employee->quota == '1'){echo "selected";}?> >Yes</option>
                              <option value="2" <?php if($employee->quota == '2'){echo "selected";}?> >No</option>
                            </select>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                            <select class="form-control" id="qouta_info" name="qouta_info">
                              <option value="">---select---</option>
                              <option value="1" <?php if($employee->qouta_info == '1'){echo "selected";}?> >Freedom Fighter</option>
                              <option value="2" <?php if($employee->qouta_info == '2'){echo "selected";}?> >Physically challenged</option>
                              <option value="3" <?php if($employee->qouta_info == '3'){echo "selected";}?> >Ethnic</option>
                              <option value="4" <?php if($employee->qouta_info == '4'){echo "selected";}?> >Women</option>
                              <option value="5" <?php if($employee->qouta_info == '5'){echo "selected";}?> >Others</option>
                            </select>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                            <select class="form-control" id="qouta_type" name="qouta_type">
                              <option value="">---select---</option>
                              <option value="1" <?php if($employee->qouta_type == '1'){echo "selected";}?> >Freedom Fighter</option>
                              <option value="2" <?php if($employee->qouta_type == '2'){echo "selected";}?> >Freedom Fighter Son/Daughter </option>
                              <option value="3" <?php if($employee->qouta_type == '3'){echo "selected";}?> >Freedom Fighter Grandson/Granddaughter </option>
                            </select>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6" style="display:none" id="district_sec">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                            <?php echo form_dropdown('district', districtOption(), $employee->district, 'id="district" class="form-control"'); ?>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                            <input type="text" class="form-control" name="prl_date" id="prl_date" value="<?= $employee->prl_date;?>" readonly>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                            <input type="text" class="form-control" name="login_id" id="login_id" value="<?= $employee->employee_id;?>" readonly>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
