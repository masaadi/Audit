                  ...
                  <div class="row">                      
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-4 col-form-label">Service Defination<sup class="error">*</sup></label>
                          <div class="col-sm-8">
                  ...
                  <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                            <input type="text" class="form-control" name="employee_id" id="employee_id" value="<?= $employee_id;?>" readonly>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
...
<script type="text/javascript">
  $(document).on('change', '#service_type', function () {
        ...
        $.ajax({
            url: "<?php echo base_url() ?>applicant/service_registration/get_document_list",
            type: 'POST',
