  ...
  <tbody>
      ...
      <tr>
                  ...
                  <?php if($data['status'] == 'pending'): ?>
                    ...
                    <?php elseif($data['status'] == 'completed'):?>
                      ...
                      <?php if(!empty($data['document'])):?>
                        <span><a href="<?php echo base_url()?><?= $data['document']?>" title="Download Attachment" target="blank"><i class="fas fa-cloud-download-alt"></i></a></span>
                      <?php endif;?>
                  <?php endif;?>
              ...
              <td>
                ...
                <?php if(($this->session->userdata('DX_user_id') == ($data['created_by']) || ($employee_id == $data['employee_id'])) && ($data['status'] == 'deny')):?>
							  <button type="button" class="btn btn-sm btn-warning mt-1" title="EDIT"
