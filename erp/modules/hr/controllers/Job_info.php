...
class Job_info extends BaseController
{
    public function __construct()
    {
        ...
        $this->load->model('hr/job_info_model', 'personal_model');
    }
    ...
    public function index(){
        ...
        $config['base_url'] = base_url() . 'hr/job_info/index';
   ...
   public function paginate_data()
    {
        ...
        $config['target'] = '#blogList';
        $config['base_url'] = base_url() . 'hr/job_info/paginate_data';
        $config['total_rows'] = $totalRec;
        $config['per_page'] = $this->total_row;
        $config['link_func'] = 'searchFilter';
        $this->ajax_pagination->initialize($config);
        ...
        $this->load->view('hr/job_info/home', $data);

    }
	
	public function add()
    {       
        $this->load->view('hr/job_info/entry');
    }
    ...
    public function edit($id){
        ...
        $this->load->view('hr/job_info/edit', $data);
    }
    ...
    public function show($id,$count1){
        ...
        $this->load->view('hr/job_info/show', $data);
    }
    ...
    public function generateListPdf(){
        ...
        $data['pdf'] = 1;
        $html = $this->load->view('hr/job_info/pdf', $data, true);
        $mpdf->SetHtmlHeader('');
        $mpdf->WriteHTML($html);
