...
class Training_info extends BaseController
{
    public function __construct()
    {
        ...
        $this->load->model('hr/training_info_model', 'personal_model');
    }
    ...
    public function index(){
        ...
        $config['base_url'] = base_url() . 'hr/training_info/index';
   ...
   public function paginate_data()
    {
        ...
        $config['target'] = '#blogList';
        $config['base_url'] = base_url() . 'hr/training_info/paginate_data';
        $config['total_rows'] = $totalRec;
        $config['per_page'] = $this->total_row;
        $config['link_func'] = 'searchFilter';
        $this->ajax_pagination->initialize($config);
        ...
        $this->load->view('hr/training_info/home', $data);

    }
	
	public function add()
    {       
        $this->load->view('hr/training_info/entry');
    }
    ...
    public function edit($id){
        ...
        $this->load->view('hr/training_info/edit', $data);
    }
    ...
    public function show($id,$count1){
        $data['employee'] = $this->db->where('id',$id)->get('training_info')->row();       
        $this->load->view('hr/training_info/show', $data);
    }
