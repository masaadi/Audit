...
class Family_info extends BaseController
{
    public function __construct()
    {
        ...
        $this->load->model('hr/family_info_model', 'personal_model');
    }
    ...
    public function index(){
        ...
        $config['base_url'] = base_url() . 'hr/family_info/index';
   ...
   public function paginate_data()
    {
        ...
        $config['target'] = '#blogList';
        $config['base_url'] = base_url() . 'hr/family_info/paginate_data';
        $config['total_rows'] = $totalRec;
        $config['per_page'] = $this->total_row;
        $config['link_func'] = 'searchFilter';
        $this->ajax_pagination->initialize($config);
        ...
        $this->load->view('hr/family_info/home', $data);

    }
	
	public function add()
    {       
        $this->load->view('hr/family_info/entry');
    }
    ...
    public function edit($id){
        ...
        $this->load->view('hr/family_info/edit', $data);
    }
    ...
    public function show($id,$count1){
        $data['spouse_info'] = $this->personal_model->get_spouse_info($id);
        $data['child_info'] = $this->personal_model->get_child_info($data['spouse_info']->employee_id);       
        $this->load->view('hr/family_info/show', $data);
    }
