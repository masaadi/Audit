                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                          <input type="text" id="training_type" class="form-control" name="training_type" value="<?php if($employee->training_type == '1'){echo "National";}else{echo "International";}?>" readonly>
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                           <input type="text" name="topics" id="topics" class="form-control" value="<?= $employee->topics;?>" readonly>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                            <input type="text" name="place" id="place" class="form-control" value="<?= $employee->place;?>" readonly>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                            <input type="text" class="form-control" name="institute" id="institute" value="<?= $employee->institute;?>" readonly>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                            <input type="text" class="form-control" name="Address" id="Address" value="<?= $employee->institute_address;?>" readonly>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                            <input type="text" class="form-control" name="duration" id="duration" value="<?= $employee->duration;?>" readonly>
                          </div>
                        </div>
                      </div>
