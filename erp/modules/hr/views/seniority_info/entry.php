            ...
            <div class="col-md-12 grid-margin stretch-card">
              ...
              <h2 class="add_button">
                ...
                <div class="card-body p-5">
                  <?php echo form_open_multipart('', array('id' => 'seniority_info_add')); ?>
                  <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-4 col-form-label">Teletalk Number<sup class="error">*</sup></label>
                          <div class="col-sm-8">
                            <input type="text" class="form-control" name="employee_id" id="employee_id" value="" onblur="get_emp_info()">
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                            <input type="number" name="position" id="position" value="" class="form-control">
                          </div>
                        </div>
                      </div>
                  </div>
