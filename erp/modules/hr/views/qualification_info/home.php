<table id="examplee" class="table table-striped table-bordered table-responsive" style="width:100%">
  ...
  <tbody>
      ...
      <tr>
              ...
              <td>
                <button type="button" class="btn btn-sm btn-warning mt-1" title="Show"
                      onclick="show_master('<?php echo $data["employee_id"] ?>','<?php echo $count;?>')"  data-backdrop="static"
                      data-keyboard="false">Show</button>
							  <button type="button" class="btn btn-sm btn-warning mt-1" title="Edit"
                      onclick="edit_master('<?php echo $data["employee_id"] ?>','<?php echo $count;?>')"  data-backdrop="static"
