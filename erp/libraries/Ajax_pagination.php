...
class Ajax_pagination {
    ...
    var $num_links = 2;
    var $cur_page = 0;
    var $first_link = '<i class="fa fa-angle-double-left" aria-hidden="true"></i>';
    var $next_link = '<span class="glyphicon glyphicon-chevron-right"></span>';
    var $prev_link = '<span class="glyphicon glyphicon-chevron-left"></span>';
    var $last_link = '<i class="fa fa-angle-double-right" aria-hidden="true"></i>';
    var $uri_segment = 4;
    var $full_tag_open = '<div class="text-center"><ul class="pagination justify-content-center">';
    var $full_tag_close = '</ul></div>';
    var $first_tag_open = '<li class="page-link">';
    var $first_tag_close = '</li>';
    var $last_tag_open = '<li class="page-link">';
    var $last_tag_close = '</li>';
    var $cur_tag_open = '<li class="active page-item"><a class="page-link" href="javascript:void(0);">';
    var $cur_tag_close = '</a></li>';
    var $next_tag_open = '<li class="page-link">';
    var $next_tag_close = '</li>';
    var $prev_tag_open = '<li class="page-link">';
    var $prev_tag_close = '</li>';
    var $num_tag_open = '<li class="page-link">';
    ...
    function create_links() {
        ...
        if ($num_pages == 1) {
            $info = '<span class="pg-info"> Showing : ' . $this->total_rows . '</span>';
            return $info;
        }
        ...
        if ($this->show_count) {
            ...
            //var_dump($curr_offset); die;
            $info = '<span class="pg-info">  Showing ' . ( $curr_offset + 1 ) . ' to ';
        ...
        $output = $info. $this->full_tag_open . $output . $this->full_tag_close;
        ?>
        <script>
