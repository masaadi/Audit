...
<aside id="leftsidebar" class="sidebar">
    ...
    <div class="user-info">
        <div class="image">
            <imgoo src="<?php echo base_url(); ?>/public/images/user.png" width="48" height="48" alt="User"/></div>
    ...
    <div class="menu">
        <ul class="list">
            ...
            $activeTab = "";
			$user_id = $this->userId;
            $module_array = usermodule_by_id($user_id);
            ...
            foreach ($module_array as $temp) {
                ...
                <li <?php if (isset($session_module_id) && ($session_module_id == $temp->ID)): ?> class="active" <?php endif; ?>>
                    <a href="#" class="menu-toggle">
						...
						<?php //echo $temp->MATERIAL_ICON; ?></i>
                        <span><?php echo ucfirst($temp->MODULE_NAME); ?> </span> </a>
                    <?php 
					
					
					$sub_module_array = userSubModuleById($user_id, $temp->ID);
					
					//$this->Shows->getThisValue("MODULE_ID = '$temp->ID'", "MASTER_SUB_MODULE","","","SORTING_ORDER ASC");?>
                     <ul class="ml-menu">
                         <?php
                            ...
                            <li <?php if (isset($session_sub_module_id) && ($session_sub_module_id == $temp_1->ID)): ?> class="active" <?php endif; ?>>
                                ...
                                <ul class="ml-menu">
                                    ...
                                    foreach ($menu_array as $temp_2) {									
										 $check = $this->Shows->getThisValue("USER_ID = '$user_id' AND MODULE_ID = '$temp->ID' AND SUB_MODULE_ID = '$temp_1->ID' AND MENU_ID = '$temp_2->ID'", "USER_MENU_PRIVILEGE");
                                       if(count($check)):
